...
categoryRouter.post('/create-category',isAuth,isAdmin,createCategoryController);

categoryRouter.delete('/delete-category/:id',isAuth,isAdmin,deleteCategoryController);

categoryRouter.put('/update-category/:id',isAuth,isAdmin,updateCategoryController);
